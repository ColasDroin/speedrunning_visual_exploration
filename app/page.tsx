        ...
        <div className="grid w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 mt-15">
          <div className="grid-cols-1">
            {showSafariDisclaimer && (
              <div className="mt-5 bg-yellow-100 border border-yellow-300 text-yellow-700 rounded-lg p-5 text-center">
                <p>
                  ...
                  the best experience, we recommend using a Chromium-based
            ...
            <div className="mx-auto ">
              ...
              exceptional skill to achieve record-breaking times. But
              speedrunning is more than just rushing a game: it’s a battle
              against the clock, against the game, and sometimes, against the
              limits of what was thought possible. It’s about taking a game you
            ...
            <p>
              ...
              has been around pretty much since the beginning of video games,
              and while a lot of people keep running games on original consoles
              or PC, some also use emulators, which let you play games from
            ...
            <div className="mx-auto mt-2">
              ...
              ABOUT THE DATA Since the number of submitted runs easily exceed
              the 4M mark, I decided to mainly focus only on the top 50 games
              with the most submissions, only keeping verified runs for
              full-game categories (per-level categories are not considered).
              Also, the data only goes back to 2012, and speedrunning is a
              practice that has been around for much longer... but we have to
              start somewhere, and speedrun.com is nowadays considered the main
              hub for speedrunning.
            </div>
            <div
            ...
            <p>
              ...
              do whatever it takes to finish fast, and "100%" where you aim to
              do everything in the game. Some speedruns are even broken down by
              level, where players focus on beating individual stages as fast as
              they can. With all these different categories, there's something
              for every kind of speedrunner, and it keeps the community fresh
              and competitive. The figure belows illustrate the main categories
            ...
            <div className="mt-15 bg-gray-100 border border-gray-300 rounded-lg p-5 flex">
              ...
              <div>
                ...
                <p className="mt-2 text-gray-700">
                  I'm currently transitioning from academia in the hope of
                  living from my data visualization work. This is my first
                  project, and I'm thrilled to share it with you! Your support
                  means the world to me, whether it's by buying me a coffee,
                  sharing my work on social media, or simply spreading the word.
                </p>
                <div className="mt-4">
                  <a
            ...
            <div className="mt-10 bg-gray-200 border border-gray-300 rounded-lg p-5">
              <p className="text-sm text-gray-600">
                ...
                affiliated with, endorsed, sponsored, or specifically approved
                by any video game company or its licensors. All data, including
