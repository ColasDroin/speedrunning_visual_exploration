  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          ["--mountain-base" as never]: "10vw",
          ["--mountain-height" as never]: "5vw",
          ["--mountain-color1" as never]: "#a684cb",
          ["--mountain-color2" as never]: "#681e6b",
          ["--mountain-tilt" as never]: "59deg",
          ["--mountain-offset" as never]: "20vw",
        }}
      ></div>
      ...
      <div className={styles.text}>
        ...
        <div
          className={`${styles.chrome} ${styles.shine}`}
          data-text="DESIGN"
          style={{ ["--shine-delay" as never]: "1s" }}
        >
          DESIGN
          <span className={`${styles.spark} ${styles.sparkOffset}`}></span>
        </div>
      </div>
